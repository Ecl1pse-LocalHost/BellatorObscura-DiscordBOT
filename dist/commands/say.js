...
exports.sayCommand = {
    ...
    async execute(interaction) {
        ...
        const hasAdmin = member.permissions.has(discord_js_1.PermissionFlagsBits.Administrator);
        ...
        if (!targetChannel ||
            targetChannel.type === discord_js_1.ChannelType.GuildCategory ||
            targetChannel.type === discord_js_1.ChannelType.GuildDirectory ||
            targetChannel.type === discord_js_1.ChannelType.GuildForum ||
            targetChannel.type === discord_js_1.ChannelType.GuildMedia) {
            await interaction.editReply({
